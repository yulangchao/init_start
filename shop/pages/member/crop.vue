	...
	<view class="container">
		<view class="page-body uni-content-info">
			...
			<view class='cropper-config'>
				<button type="primary reverse" @click="getImage" style='margin-top: 30upx;'> 选择图片进行裁剪 </button>
				...
				ctx.draw(true, () => {
					...
					uni.canvasToTempFilePath({
						...
						success: (res) => {
							uni.hideLoading()
							console.log(res);
							this.$eventHub.$emit('fire', res.tempFilePath);
							uni.navigateBack({
								delta:1
							})
// 							uni.redirectTo({
// 								url: `./profile?img=${res.tempFilePath}`
// 							});
							// 成功获得地址的地方
// 							uni.previewImage({
